 ...
 */
public class PDCAwareRoundRobinPolicy implements LoadBalancingPolicy {
	 ...
	 * Cassandra).
	 */
	public PDCAwareRoundRobinPolicy(String localDc) {
		this(localDc, 0);
	}
	 ...
	 */
	public PDCAwareRoundRobinPolicy(String localDc, int usedHostsPerRemoteDc) {
	...
	private String safeDc(Host host) {
		String dc = host.getDatacenter();
		if(dc == null) {
			logger.warn("Host {} returned null datacenter", host);
			return null;
		}
		return dc;
	}
	 ...
	 * {@code REMOTE}, see {@link #PDCAwareRoundRobinPolicy(String, int)}.
	 *
